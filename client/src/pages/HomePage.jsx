...
const HeroBanner = () => (
  <section className="hero-banner">
    ...
    <div className="auth-buttons">
      ...
      <Link to="/register" className="auth-button">Create Account</Link>
    </div>
    <div className="hero-content">
      <h1 className="hero-heading">FOCUS</h1>
      <Link to="#services" className="hero-button">SEE MORE</Link>
    </div>
  </section>
);
  ...
  <section className="services-section">
    <div className="services-container">
      <div className="services-header">
        ...
        <Link to="#products" className="services-learn-btn">LEARN MORE</Link>
      </div>
...
const HeroSlideSection = () => (
  <section className="hero-slide-section">
    <div className="hero-slide-content">
      ...
      <Link to="#" className="hero-slide-btn">Learn More</Link>
    </div>
  </section>
);
